...
INSERT INTO `service_proposition` (`id`,`name`, `description`, `price`, `picture`) VALUES (1, 'Cafards - Blattes', 'Le cafard est un insecte très résistant. Il se faufile dans la salle de bain et la cuisine, deux points stratégiques de votre logement. Pour les faire partir durablement, contactez nous par téléphone ou demandez votre devis en ligne.', 69, 'cafards.jpg');
INSERT INTO `service_proposition` (`id`,`name`, `description`, `price`, `picture`) VALUES (2, 'Rats - Souris', 'Notre société de dératisation, désinsectisation et désinfection est votre partenaire de choix pour régler tous vos problèmes de rongeurs. Alors n''attendez pas et contactez nous par téléphone ou demandez votre devis en ligne', 129, 'rats.jpg');
INSERT INTO `service_proposition` (`id`,`name`, `description`, `price`, `picture`) VALUES (3, 'Nid de Frelons - Guêpes', 'Éliminez les nids de frelons avec notre service de désinsectisation expert. Rapidité, sécurité et efficacité garanties. Protégez votre environnement dès maintenant !', 149, 'frelon.jpg');
